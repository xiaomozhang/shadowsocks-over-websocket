...
### 2.Fork [本项目](https://github.com/xiaomozhang/shadowsocks-over-websocket) 到个人账号下
![1](./imgs/1.jpg)
进入 <https://github.com/xiaomozhang/shadowsocks-over-websocket> 页面  ==>  Fork
...
2. 执行 `git clone https://github.com/xiaomozhang/shadowsocks-over-websocket.git` 命令
1. **进到本项目目录**，执行`npm install` 命令
2. 执行 `node local.js -s app名称.herokuapp.com -l 1080 -m 设置的加密算法 -k 设置的密码 -p 80` 命令，启动成功


## Chrome 浏览器配置
1. 下载 [Chrome](http://www.google.cn/chrome/browser/desktop/index.html) 浏览器插件 [SwitchyOmega](https://github.com/xiaomozhang/shadowsocks-over-websocket/raw/master/extensions/SwitchyOmega.crx)
